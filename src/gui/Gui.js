...
export default class Gui {
	...
	setupHelp() {
		...
		const defaultHelpOpen = window.CosmoTrail && window.CosmoTrail.defaults && window.CosmoTrail.defaults.showHelp;
		if (defaultHelpOpen) {
