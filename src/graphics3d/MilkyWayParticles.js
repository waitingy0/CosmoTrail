...
import { BufferAttribute, BufferGeometry, Color, Object3D, Vector3, ShaderMaterial, AdditiveBlending, Points } from 'three';
...
function generateStars(shaders, stars, starTexture, size, rendered) {
	...
	for (let i = 0, i3 = 0; i < count; i++, i3 += 3) {
		...
		if (mag < 7) {
			...
			starColor = lightenDarkenColor(starColor, ((1 / mag) ** 0.01));
